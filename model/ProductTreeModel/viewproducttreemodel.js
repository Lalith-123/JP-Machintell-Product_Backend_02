    ...
    try {
        ...
        for (let i = 0; i < productTree1.length; i++) {
            ...
            for (let j = 0; j < productTree_sub.length; j++) {
                productTree["subassemblies"][productTree_sub[j].sub_assembly_id] = { "name": productTree_sub[j].subassembly_name, "parent": productTree1[i].sub_assembly_id, "isChildrenNeeded": productTree_sub[j].to_add_assemblies };
